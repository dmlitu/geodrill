...
const ALL_BLOG_POSTS = [
  {
    ...
    baslik: "CPT Verisiyle Tork Hesabını Güçlendirmek: qc Değerinin Doğru Kullanımı",
    ozet: "GeoDrill'in direnç yolu önceliğinde CPT qc, SPT N'den daha güvenilir bir girdi olarak değerlendirilir. qc verisini doğru toplama, birim dönüşümü ve hesaba entegre etme adımları.",
    yazar: { ad: "Olgun Ergenç", unvan: "Jeoloji Mühendisi", avatar: "OE" },
    tarih: "2 Eylül 2026", okumaSuresi: 6,
    resimRenk: "#0284C7", etiketler: ["CPT", "qc", "Veri Kalitesi"],
  },
  {
    id: 7,
    kategori: "Saha Deneyimi",
    baslik: "35 Yıllık Sahadan: Ayrışmış Kaya Formasyonlarında Delgi Notları",
    ozet: "Anadolu Yakası'nda yürütülen ayrışmış kaya formasyonu projelerinde otuz beş yılı aşkın saha gözlemine dayanan pratik notlar: RQD'nin sahada gerçekte nasıl okunduğu, alet aşınması ve süre tahminindeki sapmalar.",
    yazar: { ad: "Erdin Azak", unvan: "Kıdemli Jeoloji Mühendisi", avatar: "EA" },
    tarih: "20 Ağustos 2026", okumaSuresi: 7,
    resimRenk: "#0369A1", etiketler: ["Ayrışmış Kaya", "Saha Deneyimi", "RQD"],
  },
  {
    id: 1,
    kategori: "Saha Deneyimi",
